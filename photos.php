        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card">
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Belgium E.T</h5>
                <p class="card-text">
                E.T joue pour les diable rouge 
                </p>
                <a href="#!" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary">Button</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <div class="card">
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Boudha E.T</h5>
                <p class="card-text">
               E.T en thailand
                </p>
                <a href="#!" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary">Button</a>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Belgium E.T</h5>
                <p class="card-text">
                 E.T mange une gauffre de bruxelles
                </p>
                <a href="#!" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary">Button</a>
              </div>
            </div>
